...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: 'chris', uid: 0000, provider: "Github", email: "email@email.com") }
    let (:user2) { User.new(username: 'chris', uid: 0001, provider: "Github", email: "boo@email.com") }
