...
describe User do
  ...
  describe "validations" do
    ...
    it "requires a unique username" do
      ...
      user1 = User.new(username: username, uid: 1287, provider: "Github", email: "cool@guy.com")

      # This must go through, so we use create!
      user1.save!

      user2 = User.new(username: username, uid: 1298, provider: "Github", email: "cool@guy.com")
      result = user2.save
